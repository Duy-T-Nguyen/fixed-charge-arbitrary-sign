...
The supplement is archived at \textsc{doi}~\href{https://doi.org/10.5281/zenodo.22868105}{\texttt{10.5281/zenodo.22868105}}, which pins Lean \texttt{v4.29.0} and Mathlib \texttt{v4.29.0}; the mapping from each registered claim to the theorem that discharges it, and the two trust bases involved, are given in \texttt{ARTIFACT.md} there. The Zangwill characterisation is proved in the text and audited against the primary source; it is not formalized.
